...
# Có 2 bảng song song (cùng bộ mã) - tiếng Việt dùng cho giao diện xem trên web,
# tiếng Anh dùng riêng cho file Excel xuất ra (theo yêu cầu chuẩn hóa dữ liệu).
# ---------------------------------------------------------------------------
COUNTRY_CODES = {
    ...
    "PER": "Peru", "VEN": "Venezuela", "CUB": "Cuba",
    "ZAF": "Nam Phi", "EGY": "Ai Cập", "NGA": "Nigeria", "KEN": "Kenya",
    "MAR": "Morocco", "DZA": "Algeria", "TUN": "Tunisia", "ETH": "Ethiopia",
    "SAU": "Ả Rập Xê Út", "ARE": "UAE", "ISR": "Israel", "IRN": "Iran",
    "IRQ": "Iraq", "QAT": "Qatar", "KWT": "Kuwait", "JOR": "Jordan", "LBN": "Liban",
    "SYR": "Syria", "YEM": "Yemen", "OMN": "Oman", "BHR": "Bahrain",
    "AFG": "Afghanistan", "LKA": "Sri Lanka", "NPL": "Nepal", "BTN": "Bhutan",
    "MDV": "Maldives", "MNG": "Mông Cổ", "KAZ": "Kazakhstan", "UZB": "Uzbekistan",
    "IRL": "Ireland", "ISL": "Iceland", "LUX": "Luxembourg", "MLT": "Malta",
    "CYP": "Síp", "EST": "Estonia", "LVA": "Latvia", "LTU": "Lithuania",
    "SVN": "Slovenia", "HRV": "Croatia", "SRB": "Serbia", "ALB": "Albania",
    "BLR": "Belarus", "MDA": "Moldova", "GEO": "Georgia", "ARM": "Armenia",
    "AZE": "Azerbaijan", "TWN": "Đài Loan", "HKG": "Hồng Kông", "MAC": "Ma Cao",
    "FJI": "Fiji", "PNG": "Papua New Guinea",
    "UTO": "Utopia (mã ví dụ ICAO)",
}

COUNTRY_CODES_EN = {
    "VNM": "Vietnam", "USA": "United States", "GBR": "United Kingdom", "FRA": "France",
    "DEU": "Germany", "D": "Germany", "ITA": "Italy", "ESP": "Spain", "PRT": "Portugal",
    ...
    "BGR": "Bulgaria", "GRC": "Greece", "TUR": "Turkey", "RUS": "Russia",
    "UKR": "Ukraine", "CHN": "China", "JPN": "Japan", "KOR": "South Korea",
    "PRK": "North Korea", "IND": "India", "PAK": "Pakistan", "BGD": "Bangladesh",
    "THA": "Thailand", "LAO": "Laos", "KHM": "Cambodia", "MMR": "Myanmar",
    "MYS": "Malaysia", "SGP": "Singapore", "IDN": "Indonesia", "PHL": "Philippines",
    ...
    "MAR": "Morocco", "DZA": "Algeria", "TUN": "Tunisia", "ETH": "Ethiopia",
    "SAU": "Saudi Arabia", "ARE": "United Arab Emirates", "ISR": "Israel", "IRN": "Iran",
    "IRQ": "Iraq", "QAT": "Qatar", "KWT": "Kuwait", "JOR": "Jordan", "LBN": "Lebanon",
    "SYR": "Syria", "YEM": "Yemen", "OMN": "Oman", "BHR": "Bahrain",
    "AFG": "Afghanistan", "LKA": "Sri Lanka", "NPL": "Nepal", "BTN": "Bhutan",
    "MDV": "Maldives", "MNG": "Mongolia", "KAZ": "Kazakhstan", "UZB": "Uzbekistan",
    "IRL": "Ireland", "ISL": "Iceland", "LUX": "Luxembourg", "MLT": "Malta",
    "CYP": "Cyprus", "EST": "Estonia", "LVA": "Latvia", "LTU": "Lithuania",
    "SVN": "Slovenia", "HRV": "Croatia", "SRB": "Serbia", "ALB": "Albania",
    "BLR": "Belarus", "MDA": "Moldova", "GEO": "Georgia", "ARM": "Armenia",
    "AZE": "Azerbaijan", "TWN": "Taiwan", "HKG": "Hong Kong", "MAC": "Macao",
    "FJI": "Fiji", "PNG": "Papua New Guinea",
    "UTO": "Utopia (ICAO example code)",
}
...
def parse_td3(line1: str, line2: str) -> MRZResult:
    ...
    return MRZResult(
        ...
        issuing_country_name_en=COUNTRY_CODES_EN.get(country_code, "Unknown"),
        surname=surname,
        given_names=given_names,
        passport_number=passport_number,
        nationality_code=nationality_code,
        nationality_name=COUNTRY_CODES.get(nationality_code, "Không xác định"),
        nationality_name_en=COUNTRY_CODES_EN.get(nationality_code, "Unknown"),
